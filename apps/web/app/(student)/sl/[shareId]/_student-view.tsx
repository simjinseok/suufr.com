...
export default function StudentView({ studentName, sessions, showPayments, hasUnpaid, teacher }: Props) {
        ...
        ? (
            <div>
              ...
              <div className="px-5 flex items-center justify-between">
                ...
                {/* 납부 상태 (showPayments 켜진 공유만) — 학생 단위 잔액 기준, 금액 비노출 (§6-10) */}
                {showPayments && hasUnpaid !== null && (
                  hasUnpaid
                    ? (
