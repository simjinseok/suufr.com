...
export const config = {
  matcher: [
     ...
     */
    '/((?!api|webhook|.well-known|auth|health|login|signup|verify-email|forgot-password|reset-password|pricing|terms|privacy|refunds|auth/logout|sl/*|_next/static|_next/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).+)',
  ],
};
