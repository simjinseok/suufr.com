...
export default function MemberProfileImageUpload({ name, value, onChange, onPublicIdChange, disabled, currentImageUrl }: Props) {
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      >
        <Avatar size="lg">
          {displayImageUrl
            ? <Avatar.Image src={getProfileImageSrc(displayImageUrl, AVATAR_DISPLAY_SIZE)} alt={name} />
            : null}
